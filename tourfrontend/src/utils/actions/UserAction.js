...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`http://localhost:5000/api/v1/user/update/profile`, userData, config);
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`http://localhost:5000/api/v1/user/password/forgot`, email, config);
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`http://localhost:5000/api/v1/user/password/reset/${token}`,
      passwords,
      config
    );
...
export const updateUser = (id, userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`http://localhost:5000/api/v1/admin/user/${id}`,
      userData,
      config
    );
